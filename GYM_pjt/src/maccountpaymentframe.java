...
public class maccountpaymentframe extends JFrame {
	...
	public maccountpaymentframe() {
		...
		ImageIcon accountpaymentIcon = new ImageIcon(
				"D:\\JAVA Programming\\GYM_pjt\\map.png");
		...
		pjb.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				if (phonenumber.length() != 13) {
					...
					maccountpaymentsuccessframe Maccountpaymentsuccessframe = new maccountpaymentsuccessframe();
					Maccountpaymentsuccessframe.setVisible(true);
					setVisible(false);
				}
			}
		});
	...
	public void updateDateTimejb() {
		...
		if (membershipframe.month != 12) {
			cal.add(Calendar.MONTH, membershipframe.month);
		} else {
