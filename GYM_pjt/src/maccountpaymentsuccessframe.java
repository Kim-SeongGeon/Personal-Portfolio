...
public class maccountpaymentsuccessframe extends JFrame {

	public maccountpaymentsuccessframe() {
		setTitle("");
		...
		// 카드 결제 이미지 ImageIcon
		ImageIcon maccountIcon = new ImageIcon(
				"D:\\JAVA Programming\\GYM_pjt\\maccount.png");
		Image maccount = maccountIcon.getImage();
		Image changemaccount = maccount.getScaledInstance(450, 630, Image.SCALE_SMOOTH);
		ImageIcon changemaccountIcon = new ImageIcon(changemaccount);
		...
		homejb.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) {
				new membershipnumber(maccountpaymentframe.phonenumber, maccountpaymentframe.formattedDateTime,
						maccountpaymentframe.formattedDateTime1);
				setVisible(false);
			}
		});
		...
		backjb.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) {
				maccountpaymentframe.phonenumber = "";
				new maccountpaymentframe();
				setVisible(false);
			}
		});
		...
		JLabel stjb = new JLabel(maccountpaymentframe.formattedDateTime);
		...
		JLabel etjb = new JLabel(maccountpaymentframe.formattedDateTime1);
		...
		JLabel pnjb = new JLabel("010  -  " + maccountpaymentframe.phonenumber);
		...
		// 카드 결제 이미지 넣는 JLabel
		JLabel cpjb = new JLabel(changemaccountIcon);
