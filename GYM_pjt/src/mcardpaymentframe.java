...
public class mcardpaymentframe extends JFrame {
	...
	public mcardpaymentframe() {
		...
		ImageIcon cardpaymentIcon = new ImageIcon(
				"D:\\JAVA Programming\\GYM_pjt\\mcp.png");
		...
		pjb.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				if (phonenumber.length() != 13) {
					...
					mcardpaymentsuccessframe Mcardpaymentsuccessframe = new mcardpaymentsuccessframe();
					Mcardpaymentsuccessframe.setVisible(true);
					setVisible(false);
				}
			}
		});
