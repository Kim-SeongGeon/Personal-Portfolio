...
public class mpaypaymentframe extends JFrame {
	...
	public mpaypaymentframe() {
		...
		ImageIcon paypaymentIcon = new ImageIcon(
				"D:\\JAVA Programming\\GYM_pjt\\mpp.png");
		...
		pjb.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				if (phonenumber.length() != 13) {
					...
					mpaypaymentsuccessframe Mpaypaymentsuccessframe = new mpaypaymentsuccessframe();
					Mpaypaymentsuccessframe.setVisible(true);
					setVisible(false);
				}
			}
		});
