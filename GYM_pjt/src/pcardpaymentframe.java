...
public class pcardpaymentframe extends JFrame {
	...
	public pcardpaymentframe() {
		...
		ImageIcon cardpaymentIcon = new ImageIcon(
				"D:\\JAVA Programming\\GYM_pjt\\pcp.png");
		...
		pjb.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				if (phonenumber.length() != 13) {
					...
					pcardpaymentsuccessframe Pcardpaymentsuccessframe = new pcardpaymentsuccessframe();
					Pcardpaymentsuccessframe.setVisible(true);
					setVisible(false);
				}
			}
		});
