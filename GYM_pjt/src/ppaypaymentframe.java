...
public class ppaypaymentframe extends JFrame {
	...
	public ppaypaymentframe() {
		...
		ImageIcon paypaymentIcon = new ImageIcon(
				"D:\\JAVA Programming\\GYM_pjt\\ppp.png");
		Image paypayment = paypaymentIcon.getImage();
		Image changepaypayment = paypayment.getScaledInstance(370, 250, Image.SCALE_SMOOTH);
		...
		pjb.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				if (phonenumber.length() != 13) {
					...
					ppaypaymentsuccessframe Ppaypaymentsuccessframe = new ppaypaymentsuccessframe();
					Ppaypaymentsuccessframe.setVisible(true);
					setVisible(false);
				}
			}
		});
