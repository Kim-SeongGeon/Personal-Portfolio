...
public class pcardpaymentsuccessframe extends JFrame {

	public pcardpaymentsuccessframe() {
		setTitle("");
		...
		ImageIcon minsertcardIcon = new ImageIcon(
				"D:\\JAVA Programming\\GYM_pjt\\pinsertcard.png");
		...
		homejb.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) {
				new membershipnumber(pcardpaymentframe.phonenumber, pcardpaymentframe.formattedDateTime,
						pcardpaymentframe.formattedDateTime1);
				setVisible(false);
			}
		});
		...
		JLabel stjb = new JLabel(pcardpaymentframe.formattedDateTime);
		...
		JLabel etjb = new JLabel(pcardpaymentframe.formattedDateTime1);
		...
		JLabel pnjb = new JLabel("010  -  " + pcardpaymentframe.phonenumber);
