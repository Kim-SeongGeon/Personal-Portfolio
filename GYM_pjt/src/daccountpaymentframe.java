...
public class daccountpaymentframe extends JFrame {
	...
	public daccountpaymentframe() {
		...
		ImageIcon cardpaymentIcon = new ImageIcon(
				"D:\\JAVA Programming\\GYM_pjt\\dap.png");
		...
		pjb.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				if (phonenumber.length() != 13) {
					...
					daccountpaymentsuccessframe Daccountpaymentsuccessframe = new daccountpaymentsuccessframe();
					Daccountpaymentsuccessframe.setVisible(true);
					setVisible(false);
				}
			}
		});
