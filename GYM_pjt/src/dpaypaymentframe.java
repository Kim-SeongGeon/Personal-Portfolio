...
public class dpaypaymentframe extends JFrame {
	...
	public dpaypaymentframe() {
		...
		ImageIcon paypaymentIcon = new ImageIcon(
				"D:\\JAVA Programming\\GYM_pjt\\dpp.png");
		...
		pjb.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				if (phonenumber.length() != 13) {
					...
					dpaypaymentsuccessframe Dpaypaymentsuccessframe = new dpaypaymentsuccessframe();
					Dpaypaymentsuccessframe.setVisible(true);
					setVisible(false);
				}
			}
		});
