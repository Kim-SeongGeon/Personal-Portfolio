...
public class mcardpaymentsuccessframe extends JFrame {

	public mcardpaymentsuccessframe() {
		setTitle("");
		...
		ImageIcon minsertcardIcon = new ImageIcon(
				"D:\\JAVA Programming\\GYM_pjt\\minsertcard.png");
		...
		homejb.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) {
				new membershipnumber(mcardpaymentframe.phonenumber, mcardpaymentframe.formattedDateTime,
						mcardpaymentframe.formattedDateTime1);
				setVisible(false);
			}
		});
		...
		JLabel stjb = new JLabel(mcardpaymentframe.formattedDateTime);
		...
		JLabel etjb = new JLabel(mcardpaymentframe.formattedDateTime1);
		...
		JLabel pnjb = new JLabel("010  -  " + mcardpaymentframe.phonenumber);
